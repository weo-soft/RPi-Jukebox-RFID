...
* [components.timers.idle\_shutdown\_timer](#components.timers.idle_shutdown_timer)
  * [IdleShutdownTimer](#components.timers.idle_shutdown_timer.IdleShutdownTimer)
    * [start](#components.timers.idle_shutdown_timer.IdleShutdownTimer.start)
    * [cancel](#components.timers.idle_shutdown_timer.IdleShutdownTimer.cancel)
    * [get\_state](#components.timers.idle_shutdown_timer.IdleShutdownTimer.get_state)
...
* [components.hostif.linux](#components.hostif.linux)
  ...
  * [hdmi\_power\_down](#components.hostif.linux.hdmi_power_down)
...
* [components.volume](#components.volume)
  * [AudioMonitor](#components.volume.AudioMonitor)
    * [SoundCardConnectCallbacks](#components.volume.AudioMonitor.SoundCardConnectCallbacks)
    * [toggle\_on\_connect](#components.volume.AudioMonitor.toggle_on_connect)
    * [toggle\_on\_connect](#components.volume.AudioMonitor.toggle_on_connect)
    * [stop](#components.volume.AudioMonitor.stop)
    * [run](#components.volume.AudioMonitor.run)
  * [VolumeControl](#components.volume.VolumeControl)
    * [OutputChangeCallbackHandler](#components.volume.VolumeControl.OutputChangeCallbackHandler)
    * [OutputVolumeCallbackHandler](#components.volume.VolumeControl.OutputVolumeCallbackHandler)
    * [toggle\_output](#components.volume.VolumeControl.toggle_output)
    * [get\_outputs](#components.volume.VolumeControl.get_outputs)
    * [publish\_volume](#components.volume.VolumeControl.publish_volume)
    * [publish\_outputs](#components.volume.VolumeControl.publish_outputs)
    * [set\_volume](#components.volume.VolumeControl.set_volume)
    * [get\_volume](#components.volume.VolumeControl.get_volume)
    * [change\_volume](#components.volume.VolumeControl.change_volume)
    * [get\_mute](#components.volume.VolumeControl.get_mute)
    * [mute](#components.volume.VolumeControl.mute)
    * [set\_output](#components.volume.VolumeControl.set_output)
    * [set\_soft\_max\_volume](#components.volume.VolumeControl.set_soft_max_volume)
    * [get\_soft\_max\_volume](#components.volume.VolumeControl.get_soft_max_volume)
    * [card\_list](#components.volume.VolumeControl.card_list)
...
* [jukebox.multitimer](#jukebox.multitimer)
  * [MultiTimer](#jukebox.multitimer.MultiTimer)
    * [\_\_init\_\_](#jukebox.multitimer.MultiTimer.__init__)
    * [cancel](#jukebox.multitimer.MultiTimer.cancel)
    * [trigger](#jukebox.multitimer.MultiTimer.trigger)
    * [run\_endless](#jukebox.multitimer.MultiTimer.run_endless)
    * [run\_limited](#jukebox.multitimer.MultiTimer.run_limited)
...
<a id="components.timers.idle_shutdown_timer"></a>

# components.timers.idle\_shutdown\_timer

<a id="components.timers.idle_shutdown_timer.IdleShutdownTimer"></a>

## IdleShutdownTimer Objects

```python
class IdleShutdownTimer()
```

<a id="components.timers.idle_shutdown_timer.IdleShutdownTimer.start"></a>

#### start

```python
@plugin.tag
def start(wait_seconds: int)
```

Sets idle_shutdown timeout_sec stored in jukebox.yaml


<a id="components.timers.idle_shutdown_timer.IdleShutdownTimer.cancel"></a>
...
<a id="components.timers.idle_shutdown_timer.IdleShutdownTimer.get_state"></a>
...
<a id="components.timers.volume_fadeout_shutdown_timer"></a>

# components.timers.volume\_fadeout\_shutdown\_timer

<a id="components.timers.volume_fadeout_shutdown_timer.VolumeFadeoutError"></a>

## VolumeFadeoutError Objects
...
<a id="components.hostif.linux.hdmi_power_down"></a>
...
<a id="components.volume.AudioMonitor"></a>

## AudioMonitor Objects
...
<a id="components.volume.AudioMonitor.SoundCardConnectCallbacks"></a>
...
<a id="components.volume.AudioMonitor.SoundCardConnectCallbacks.register"></a>

#### register

```python
def register(func: Callable[[str, bool], None])
```
...
- `is_bluetooth`: Whether stable device properties identify the
sound card as a Bluetooth device

<a id="components.volume.AudioMonitor.SoundCardConnectCallbacks.run_callbacks"></a>

#### run\_callbacks

```python
def run_callbacks(device_name: str, is_bluetooth: bool)
```



<a id="components.volume.AudioMonitor.toggle_on_connect"></a>
...
<a id="components.volume.AudioMonitor.stop"></a>
...
<a id="components.volume.AudioMonitor.run"></a>
...
<a id="components.volume.VolumeControl"></a>

## VolumeControl Objects
...
<a id="components.volume.VolumeControl.OutputChangeCallbackHandler"></a>
...
<a id="components.volume.VolumeControl.OutputChangeCallbackHandler.register"></a>
...
- `sink_name`: The audio server's sink name
...
<a id="components.volume.VolumeControl.OutputChangeCallbackHandler.run_callbacks"></a>
...
<a id="components.volume.VolumeControl.OutputVolumeCallbackHandler"></a>
...
<a id="components.volume.VolumeControl.OutputVolumeCallbackHandler.register"></a>
...
<a id="components.volume.VolumeControl.OutputVolumeCallbackHandler.run_callbacks"></a>
...
<a id="components.volume.VolumeControl.toggle_output"></a>
...
<a id="components.volume.VolumeControl.get_outputs"></a>
...
<a id="components.volume.VolumeControl.publish_volume"></a>
...
<a id="components.volume.VolumeControl.publish_outputs"></a>
...
<a id="components.volume.VolumeControl.set_volume"></a>
...
<a id="components.volume.VolumeControl.get_volume"></a>
...
<a id="components.volume.VolumeControl.change_volume"></a>
...
<a id="components.volume.VolumeControl.get_mute"></a>
...
<a id="components.volume.VolumeControl.mute"></a>
...
<a id="components.volume.VolumeControl.set_output"></a>
...
<a id="components.volume.VolumeControl.set_soft_max_volume"></a>
...
<a id="components.volume.VolumeControl.get_soft_max_volume"></a>
...
<a id="components.volume.VolumeControl.card_list"></a>
...
<a id="jukebox.multitimer.MultiTimer.__init__"></a>

#### \_\_init\_\_

```python
def __init__(interval: float,
             iterations: int,
             function: Callable,
             args=None,
             kwargs=None)
...
<a id="jukebox.multitimer.MultiTimer.run_endless"></a>
...
<a id="jukebox.multitimer.MultiTimer.run_limited"></a>
...
```python
@plugin.tag
def start(wait_seconds: Optional[float] = None)
```
...
<a id="jukebox.multitimer.GenericEndlessTimerClass.__init__"></a>
